...
ggplot(data = brews.per.capita.map) + 
  ...
  coord_fixed(1.3) + theme_nothing(legend = T) + guides(fill=guide_legend(title = "Breweries Per Capita"))
```
...
ggplot(data = IBU.map) + 
  ...
  coord_fixed(1.3) + theme_nothing(legend = T) + guides(fill=guide_legend(title = "Median Bitterness by State"))
```
...
ggplot(data = ABV.map) + 
  ...
  coord_fixed(1.3) + theme_nothing(legend = T) + guides(fill=guide_legend(title = "Median Alcohol Content by State"))
```